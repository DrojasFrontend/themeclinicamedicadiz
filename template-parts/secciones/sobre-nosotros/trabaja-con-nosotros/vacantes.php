<?php
    ...
    $grupoVacantes = get_field('grupo_vacantes');
    $titulo = $grupoVacantes['titulo'] ?? '';
    $descripcion = $grupoVacantes['descripcion'] ?? '';
?>
                        ...
                        <?php
                            if ($blog_query->have_posts()) :
                                while ($blog_query->have_posts()) : $blog_query->the_post();
                                        ...
                                        $clean_content = wp_strip_all_tags(do_shortcode(shortcode_unautop($content)), true);
                                    ...
                                    <div class="card border-0 bg-transparent swiper-slide">
                                        ...
                                        <div class="pt-4 d-flex flex-column flex-fill">
                                            ...
                                            <p class="card-text mt-3 flex-fill"><?php echo esc_html($clean_content); ?></p>
                                            <div class="d-flex align-items-center">
                                                <a href="<?php echo esc_url($permalink); ?>" class="btn custom-btn-link fw-bold text-decoration-none p-0 nav-underline">Aplicar a vacante</a>
