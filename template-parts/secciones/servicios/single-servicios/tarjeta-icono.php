...
<section class="py-5 bg-menu">
    <div class="container">
        <div class="col text-center">
                <h2 class="my-5"><?php echo esc_html($titulo); ?></h2>
        </div>
                                ...
                                <div class="card p-4 h-100">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="d-flex flex-column flex-fill">
                                            <h5 class="mb-0 flex-fill"><?php echo esc_html($titulo); ?></h5>
                                            <?php
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a href="<?php echo esc_url($url); ?>" class="btn-transparent fw-bold p-0 nav-underline"><?php echo esc_html($texto); ?></a>
