<?php 
    $grupoListado = get_field('grupo_tarjeta_fondo');
    $fondo = $grupoListado['fondo'] ?? '';
...
<?php if ($hayContenido): ?>
<section class="bg-cerulean-v2 py-5" style="background-image: url('<?php echo esc_url($fondo['url']); ?>');">
