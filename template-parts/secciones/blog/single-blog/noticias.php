...
<section class="bg-single-blog-notice">
    <div class="container py-5">
        <div class="row align-items-center mb-4">
            <div class="col">
                <h2 class="my-4">Recomendado para ti</h2>
            </div>
        </div>
        ...
        <div class="position-relative">
                                    ...
                                    <div class="card border-0 bg-transparent swiper-slide">
                                        ...
                                        <div class="pt-4 d-flex flex-column flex-fill">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <a href="<?php echo esc_url($permalink); ?>" class="btn-transparent fw-bold p-0">Seguir leyendo</a>
            ...
            <div class="swiper-button-next swiper-navBtn swiper-bg-blue">
                <img src="/wp-content/uploads/fi-rr-angle-small-right-3.png">
            </div>
            <div class="swiper-button-prev swiper-navBtn swiper-bg-blue">
