...
<section class="bg-menu">
    <div class="container py-5">
        <div class="row align-items-center mb-4">
            <div class="col">
                <h2 class="my-4">Otros profesionales que te podrían interesar</h2>
            </div>
        </div>
                        ...
                        <?php
                            if ($blog_query->have_posts()) :
                                while ($blog_query->have_posts()) : $blog_query->the_post();
                                    ...
                                    ?>
                                    <div class="card border-0 bg-transparent swiper-slide text-center">
                                        <figure class="bg-white">
                                            <img src="<?php echo esc_url($thumbnail); ?>" class="img-fluid d-block m-auto" alt="<?php echo esc_attr($title); ?>">
                                        </figure>
