<?php
    ...
    $args = [
        'post_type' => 'imagenesdiagnosticas',
        'posts_per_page' => 8,
        'paged' => $paged,
    ];
    $query = new WP_Query($args);

    $grupoImagenesDiagnosticas = get_field('grupo_imagenes_diagnosticas');
    $titulo = $grupoImagenesDiagnosticas['titulo'] ?? '';
    $descripcion = $grupoImagenesDiagnosticas['descripcion'] ?? '';
?>

<section class="bg-menu py-5 py-60 px-18">
    <div class="container">
        <div class="text-center mb-5">
            <h2 class="mb-2"><?php echo esc_html($titulo); ?></h2>
        ...
        <div class="row g-4" id="post-container">
            <?php if ($query->have_posts()) : ?>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mb-4 post-item">
                    <div class="card h-100 border-0">
                        ...
                        <div class="py-4 px-3 d-flex flex-column flex-fill">
                            <h6 class="card-title flex-fill"><?php the_title(); ?></h6>
                ...
                <?php endwhile; ?>
            <?php else : ?>
                <p class="text-center">No hay imágenes disponibles en este momento.</p>
            <?php endif; ?>
        </div>
